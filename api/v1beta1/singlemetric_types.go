...
const (
	...
	// PhaseFailed represents the metric has failed
...
// SetConditions sets the conditions of the SingleMetric
...
// GvkToString returns the group, version and kind of the object that should be instrumented as a string
