...
func scheduleNextReconciliation(metric *v1beta1.FederatedMetric) (ctrl.Result, error) {
...
func shouldReconcile(metric *v1beta1.FederatedMetric) bool {
...
// +kubebuilder:rbac:groups=insight.orchestrate.cloud.sap,resources=federatedmetrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=insight.orchestrate.cloud.sap,resources=federatedmetrics/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=insight.orchestrate.cloud.sap,resources=federatedmetrics/finalizers,verbs=update
...
func (r *FederatedMetricReconciler) handleSecretError(l logr.Logger, errSecret error, metric v1beta1.FederatedMetric) (ctrl.Result, error) {
