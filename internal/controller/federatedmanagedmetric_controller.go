...
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=federatedmanagedmetrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=federatedmanagedmetrics/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=federatedmanagedmetrics/finalizers,verbs=update
