...
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=metrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=metrics/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=metrics.open-control-plane.io,resources=metrics/finalizers,verbs=update
